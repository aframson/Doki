...
export default function MapScreen(props) {
  ...
  const [showLocationFormInput, setShowLocationFormInput] = useState(false);
        ...
        if (
          ...
          if (driver.location) {
            ...
            if (distance < 10) {
              ...
              driver.arriveTime = await getDriveTime(
                Platform.OS,
                startLoc,
                destLoc
              );
    ...
    <View style={styles.mainViewStyle}>
      ...
      <View style={styles.myViewStyle}>
        <View style={styles.coverViewStyle}>
          ...
          />
          <View
            style={[styles.viewStyle2, { backgroundColor: colors.BLACK }]}
          />
          <View
            style={[styles.viewStyle3, { backgroundColor: colors.BLACK }]}
          />
        </View>
        ...
        >
          ...
          {/* <View style={{ flexDirection: "row" }}>
                      ...
                      <Text style={styles.text2}>
                        ({prop.minTime != "" ? prop.minTime : null})
                      </Text>
                    </View>
                  </View>
                </View>
        ...
        tripdata.drop && tripdata.drop.add ? null : (
          ...
          >
            <BaseButton
              title={language.book_now_button}
              loading={false}
              onPress={setShowLocationFormInput(true)}
              style={{
                flex: 1,
                justifyContent: "center",
                alignItems: "center",
...
const styles = StyleSheet.create({
  ...
  myViewStyle: {
    ...
    marginVertical: 15,
    position: "absolute",
    top: Platform.OS.toLowerCase === "ios" ? 80 : 90,
    left: 0,
    right: 0,
    zIndex: 9999,
    borderRadius: 10,
