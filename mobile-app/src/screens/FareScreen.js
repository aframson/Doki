                ...
                <View style={styles.priceDetailsContainer}>
                    <View style={styles.priceDetailsLeft}>
                        ...
                        <View style={styles.iconContainer}>
                            <Text style={styles.priceText}> Gh{settings ? settings.symbol : null} {estimate ? estimate.estimateFare : null}</Text>
                        </View>
                ...
                <View style={{ flex: 1.5, flexDirection: 'row' }}>
                    <View style={styles.iconContainer}>
                        <Button
                            ...
                            buttonStyle={{ height: '100%', backgroundColor:colors.BLUE.dark}}
...
const styles = StyleSheet.create({
    ...
    whereText: { flex: 9, fontFamily: 'Roboto-Regular', fontSize: 14, fontWeight: '400', color: 'black' },
    ...
    offerContainer: { flex: 1, backgroundColor: '#669cff', width: width, justifyContent: 'center', borderBottomWidth: Platform.OS == 'ios' ? 0 : 0 },
    offerText: { alignSelf: 'center', color: 'white', fontSize: 12, fontFamily: 'Roboto-Regular' },
    ...
    priceText: { alignSelf: 'center', color: colors.GREY.iconSecondary, fontFamily: 'Roboto-Bold', fontSize: 30 },
    triangle: {
        width: 0,
        height: 0,
