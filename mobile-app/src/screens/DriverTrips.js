        ...
        renderItem={({ item, index }) => {
          return (
            <View style={styles.listItemView}>
              ...
              <View style={[styles.mapDetails, { paddingVertical: 15 }]}>
                ...
                {/* <View style={styles.rateViewStyle}>
                                    <Text style={styles.rateViewTextStyle}>{settings.symbol}{item ? item.estimate > 0 ? parseFloat(item.estimate).toFixed(0) : 0 : null}</Text>
                                </View> */}
