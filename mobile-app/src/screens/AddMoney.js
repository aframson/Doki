  ...
  return (
    <View style={styles.mainView}>
      <Header
        ...
        centerComponent={
          <Text style={styles.headerTitleStyle}>{language.add_money_tile}</Text>
        }
      ...
      <View style={styles.bodyContainer}>
        <Text style={styles.walletbalText}>
          ...
          <Text style={styles.ballance}>
            {settings.symbol}
            {state.userdata
              ? parseFloat(state.userdata.walletBalance).toFixed(2)
              : ""}
          </Text>
        </Text>
        ...
        <TextInput
          ...
          placeholder={
            language.addMoneyTextInputPlaceholder + " (" + settings.symbol + ")"
          }
        ...
        <TouchableOpacity style={styles.buttonWrapper2} onPress={payNow}>
