...
export const updateBooking = (booking) => (dispatch) => (firebase) => {
  ...
  if (booking.status == 'REACHED') {
    ...
    let platform = store.getState().auth.info.profile.userPlatform.toLowerCase();
